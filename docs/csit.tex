...
into Eq.~(\ref{Friedmann}) gives rise to the usual Friedmann equation.
...
%\end{align}
Finally, for anisotropic simulations we compute the anisotropic scale factor
...
Rewrite \eqref{disp_evo} with $\psi$ in Fourier space, 
%and change its time variable to $\ln a$
\begin{equation}
