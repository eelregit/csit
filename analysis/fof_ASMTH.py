...
def compute_fof(kind, seed):
    ...
    Aniss_data = np.loadtxt('/home/yinli/csit/analysis/Aniss/Aniss_planck2015_%s_z200_new' % (kind))
...
#    halo_cat.save('/mnt/sdceph/users/yinli/csit/planck2015/%d/np1024/%s/%s/halos' % (box, seed, kind))
    halo_cat.save('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/ASMTH6_new/halos' % (box, seed, kind))
