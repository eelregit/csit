...
def compute_power(kind):
    ...
    part_cat = Gadget1Catalog('/mnt/sdceph/users/yinli/csit/nbody/planck2015/%d/%s/%d/%s/snapdir_005/snap_005.*' % (box, force, seed, kind))
    if comm.rank == 0:
        print(part_cat)
    ...
    if comm.rank == 0:
        print('done FFT')
    FFT.save("/home/yinli/csit/analysis/power/planck2015/%d/%d/z0_%s_%s_fftpower.json" % (box, seed, force, kind))
    poles = FFT.poles
    ...
    np.savetxt('/home/yinli/csit/analysis/power/planck2015/%d/%d/z0_%s_%s_p0.dat' % (box, seed, force, kind), p0)
    np.savetxt('/home/yinli/csit/analysis/power/planck2015/%d/%d/z0_%s_%s_p2.dat' % (box, seed, force, kind), p2)
    np.savetxt('/home/yinli/csit/analysis/power/planck2015/%d/%d/z0_%s_%s_p4.dat' % (box, seed, force, kind), p4)
