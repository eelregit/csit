...
#    FFT.save('/mnt/sdceph/users/yinli/csit/planck2015/%d/np1024/%s/%s/power/z0_pm4096_fftpower.json' % (box, seed, kind))
    FFT.save('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/SIMP_ASMTH45/power/z0_fftpower.json' % (box, seed, kind))
    poles = FFT.poles
...
#    np.savetxt('/mnt/sdceph/users/yinli/csit/planck2015/%d/np1024/%s/%s/power/z0_treepm2048_p0.dat' % (box, seed, kind), p0)
    np.savetxt('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/SIMP_ASMTH45/power/z0_p0.dat' % (box, seed, kind), p0)
    np.savetxt('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/SIMP_ASMTH45/power/z0_p2.dat' % (box, seed, kind), p2)
    np.savetxt('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/SIMP_ASMTH45/power/z0_p4.dat' % (box, seed, kind), p4)
