...
#    part_cat = Gadget1Catalog('/mnt/sdceph/users/yinli/csit/planck2015/%d/np1024/%s/%s/nbody/treepm2048/snapdir_005/snap_005.*' % (box, seed, kind))
    part_cat = Gadget1Catalog('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/ASMTH6_new/nbody/snapdir_003/snap_003.*' % (box, seed, kind))
...
#    FFT.save('/mnt/sdceph/users/yinli/csit/planck2015/%d/np1024/%s/%s/power/z0_pm4096_fftpower.json' % (box, seed, kind))
    FFT.save('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/ASMTH6_new/power/z0_fftpower.json' % (box, seed, kind))
    poles = FFT.poles
...
#    np.savetxt('/mnt/sdceph/users/yinli/csit/planck2015/%d/np1024/%s/%s/power/z0_treepm2048_p0.dat' % (box, seed, kind), p0)
    np.savetxt('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/ASMTH6_new/power/z0_p0.dat' % (box, seed, kind), p0)
    np.savetxt('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/ASMTH6_new/power/z0_p2.dat' % (box, seed, kind), p2)
    np.savetxt('/mnt/sdceph/users/yinli/csit/planck2015/%d/%s/%s/ASMTH6_new/power/z0_p4.dat' % (box, seed, kind), p4)
...
#        for filename in ['mmp002', 'ppm002', 'mmp005', 'ppm005', 'mmp008', 'ppm008', 'mmp02', 'ppm02', 'mmp03', 'ppm03' , 'mmp04', 'ppm04','mmm0008', 'ppp0008', 'mmm001', 'ppp001','mmm002', 'ppp002','mmm003', 'ppp003','mmm01', 'ppp01']:
       for filename in ['ppp003', 'mmm003', 'ppp007', 'mmm007', 'ppp0004', 'mmm0004']:
#        for filename in ['mmp003', 'ppm003']:
        #for filename in ['mmp01', 'ppm01', 'mmp02', 'ppm02', 'mmp001', 'ppm001', 'mmp05', 'ppm005']:
#        for filename in ['iso']:
